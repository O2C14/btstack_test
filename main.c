...
static int btblecontroller_em_config(void)
{
    ...
    extern uint32_t rwip_btble_em_size;
    ...
    configASSERT(rwip_btble_em_size < em_size);
    printf("em size 0x%x\n", rwip_btble_em_size);
    return 0;
}
...
int main(void)
{
  ...
  */
    ...
    btblecontroller_em_config(); // For the full version of rwip, EM must be set to 64KB.
