...
{
    printf("%d%d%d%d%d%d%d%d", (data >> 7) & 1, (data >> 6) & 1, (data >> 5) & 1, (data >> 4) & 1, (data >> 3) & 1,
...
void es9038q2m_init(void)
{
    ...
    cfg->canwrite.Input_selection = 0b00000000;
...
uint8_t volume_table[] = { 0,   35,  56,  72,  83,  93,  101, 108, 114, 120, 125, 130, 134, 138, 141, 145,
                           148, 151, 154, 157, 159, 162, 164, 166, 168, 170, 172, 174, 176, 178, 180, 181,
                           183, 185, 186, 188, 189, 190, 192, 193, 194, 196, 197, 198, 199, 201, 202, 203,
                           ...
                           230, 231, 232, 232, 233, 234, 234, 235, 235, 236, 236, 237, 238, 238, 239, 239,
                           240, 240, 241, 241, 242, 243, 243, 244, 244, 245, 245, 246, 246, 247, 247, 247,
