...
#ifdef HAVE_BTSTACK_STDIN
static const char *device_addr_string = "B4:0E:CF:2A:FF:46"; // pts v5.0
...
static int setup_demo(void)
{
    ...
    gap_set_local_name("O2C14_Player[00:00:00:00:00:00]");
...
static void handle_l2cap_media_data_packet(uint8_t seid, uint8_t *packet, uint16_t size)
{
    ...
    send_to_decoder(*((uint16_t *)(packet - 8)) & 0xfff, seid, packet + 12, size - 12);
}
...
static void a2dp_sink_packet_handler(uint8_t packet_type, uint16_t channel, uint8_t *packet, uint16_t size)
{
    ...
    switch (packet[2]) {
        case A2DP_SUBEVENT_SIGNALING_MEDIA_CODEC_SBC_CAPABILITY: {
            decoder_save_sbc_config(
                a2dp_subevent_signaling_media_codec_sbc_capability_get_a2dp_cid(packet),
                packet,
        ...
        case A2DP_SUBEVENT_SIGNALING_MEDIA_CODEC_MPEG_AAC_CAPABILITY: {
            decoder_save_aac_config(
                a2dp_subevent_signaling_media_codec_mpeg_aac_capability_get_a2dp_cid(packet),
                packet,
        ...
        case A2DP_SUBEVENT_SIGNALING_MEDIA_CODEC_OTHER_CAPABILITY: {
            decoder_save_vendor_config(
                a2dp_subevent_signaling_media_codec_other_capability_get_a2dp_cid(packet),
        ...
        case A2DP_SUBEVENT_SIGNALING_CAPABILITIES_COMPLETE: {
            decoder_submit_config();
        } break;
        case A2DP_SUBEVENT_SIGNALING_MEDIA_CODEC_OTHER_CONFIGURATION:
            printf("A2DP  Sink      : Received non OTHER codec\n");
            init_decoder(a2dp_subevent_signaling_media_codec_other_configuration_get_a2dp_cid(packet),
        ...
        case A2DP_SUBEVENT_SIGNALING_MEDIA_CODEC_SBC_CONFIGURATION: {
            ...
            init_decoder(a2dp_subevent_signaling_media_codec_sbc_configuration_get_a2dp_cid(packet),
        ...
        case A2DP_SUBEVENT_SIGNALING_MEDIA_CODEC_MPEG_AAC_CONFIGURATION: {
            printf("A2DP  Sink      : Received MPEG AAC codec configuration\n");
            init_decoder(a2dp_subevent_signaling_media_codec_mpeg_aac_configuration_get_a2dp_cid(packet),
        ...
        case A2DP_SUBEVENT_STREAM_ESTABLISHED:
            ...
            //init_decoder(a2dp_subevent_stream_established_get_local_seid(packet));
        ...
        case A2DP_SUBEVENT_STREAM_RELEASED:
            ...
            decoder_release(a2dp_subevent_stream_released_get_a2dp_cid(packet),
